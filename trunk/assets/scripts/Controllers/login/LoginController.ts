...
export class LoginController extends Component {
    ...
    checkIfTimeHasPassed() {
        if (GameData.userData.resetTime !== null) {
            // 创建当天0点的Date对象
            let midnight = new Date(GameData.userData.resetTime);
    ...
    useLocalData() {
        ...
        GameData.userData.account = this._account;
    ...
    registerCallback() {
        GameData.userData.account = LoginController.instance._account;
    ...
    onAdvancedAccountsLogin() {
        ...
        const towerlist = [
            ...
            { "id": 1003, "name": "艾文", "english_name": "Zhong Kui", "hurttype": "持续型", "staff_type_id": 3, "quality": 6, "max_lv": 100, "piece_goods_id": 2003, "icon_id": 1003, "draw_id": 3003, "voice_id": 4003, "pub_id": 5003, "spine_id": "spine_1003", "idle_id": "idle_1003", "attack_id": "attack_1003", "atk": 25, "atk_base": 25, "atk_grow": 50, "bullet_spd": 1250, "atk_spd": 0.5, "range": 400, "radius": 0, "crit": 0.15, "crit_hurt": 1.2, "poison": 8, "poison_base": 8, "poi_grow": 16, "duration": 2, "slow": 0, "slow_time": 0, "is_return": 0, "build_id": 0, "introduce": "" },
            ...
            { "id": 1011, "name": "亚历克斯", "english_name": "Ox-Head", "hurttype": "持续型", "staff_type_id": 3, "quality": 6, "max_lv": 100, "piece_goods_id": 2011, "icon_id": 1011, "draw_id": 3011, "voice_id": 4011, "pub_id": 5011, "spine_id": "spine_1011", "idle_id": "idle_1011", "attack_id": "attack_1011", "atk": 4, "atk_base": 4, "atk_grow": 8, "bullet_spd": 1250, "atk_spd": 0.5, "range": 350, "radius": 0, "crit": 0.1, "crit_hurt": 1.05, "poison": 4, "poison_base": 4, "poi_grow": 8, "duration": 2, "slow": 0, "slow_time": 0, "is_return": 0, "build_id": 0, "introduce": "" },
            { "id": 1012, "name": "岩啸", "english_name": "Chakravartin", "hurttype": "持续型", "staff_type_id": 3, "quality": 6, "max_lv": 100, "piece_goods_id": 2012, "icon_id": 1012, "draw_id": 3012, "voice_id": 4012, "pub_id": 5012, "spine_id": "spine_1012", "idle_id": "idle_1012", "attack_id": "attack_1012", "atk": 8, "atk_base": 8, "atk_grow": 16, "bullet_spd": 1250, "atk_spd": 0.5, "range": 350, "radius": 0, "crit": 0.15, "crit_hurt": 1.2, "poison": 8, "poison_base": 8, "poi_grow": 16, "duration": 2, "slow": 0, "slow_time": 0, "is_return": 0, "build_id": 0, "introduce": "" },
        ];
    ...
    onJuniorLogin() {
     ...
     onTestLogin() {
        ...
        GameData.userData.play_comic = true;
        GameData.userData.create_nickname = true;
        GameData.userData.max_chapter = 160;
        GameData.userData.chapter = 160;
         const bestEquipList = {
            0:
                [{ equip_id: 3001, effect_name: "攻击", effect_value: 61423.94, equip_quality: 6, equip_lv: 50 },
                { equip_id: 3002, effect_name: "攻击", effect_value: 61423.94, equip_quality: 6, equip_lv: 50 },
