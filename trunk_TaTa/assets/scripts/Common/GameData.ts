...
export class GameData extends Component {
    ...
    static initData(isLogin: boolean) {
        ...
        if (isLogin && this.client_data.client_data.is_new == 1) {
            ...
            data.user_data.batteryStrengthenValue0 = GameData.userData.batteryStrengthenValue0,//单体型强化值
                ...
                data.user_data.hasEquip_list = [
                    { equip_id: GameData.userData.hasEquipList[0][0].equip_id, effect_name: GameData.userData.hasEquipList[0][0].effect_name, effect_value: GameData.userData.hasEquipList[0][0].effect_value, equip_quality: GameData.userData.hasEquipList[0][0].equip_quality, equip_lv: GameData.userData.hasEquipList[0][0].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[0][1].equip_id, effect_name: GameData.userData.hasEquipList[0][1].effect_name, effect_value: GameData.userData.hasEquipList[0][1].effect_value, equip_quality: GameData.userData.hasEquipList[0][1].equip_quality, equip_lv: GameData.userData.hasEquipList[0][1].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[0][2].equip_id, effect_name: GameData.userData.hasEquipList[0][2].effect_name, effect_value: GameData.userData.hasEquipList[0][2].effect_value, equip_quality: GameData.userData.hasEquipList[0][2].equip_quality, equip_lv: GameData.userData.hasEquipList[0][2].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[0][3].equip_id, effect_name: GameData.userData.hasEquipList[0][3].effect_name, effect_value: GameData.userData.hasEquipList[0][3].effect_value, equip_quality: GameData.userData.hasEquipList[0][3].equip_quality, equip_lv: GameData.userData.hasEquipList[0][3].equip_lv },

                    { equip_id: GameData.userData.hasEquipList[1][0].equip_id, effect_name: GameData.userData.hasEquipList[1][0].effect_name, effect_value: GameData.userData.hasEquipList[1][0].effect_value, equip_quality: GameData.userData.hasEquipList[1][0].equip_quality, equip_lv: GameData.userData.hasEquipList[1][0].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[1][1].equip_id, effect_name: GameData.userData.hasEquipList[1][1].effect_name, effect_value: GameData.userData.hasEquipList[1][1].effect_value, equip_quality: GameData.userData.hasEquipList[1][1].equip_quality, equip_lv: GameData.userData.hasEquipList[1][1].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[1][2].equip_id, effect_name: GameData.userData.hasEquipList[1][2].effect_name, effect_value: GameData.userData.hasEquipList[1][2].effect_value, equip_quality: GameData.userData.hasEquipList[1][2].equip_quality, equip_lv: GameData.userData.hasEquipList[1][2].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[1][3].equip_id, effect_name: GameData.userData.hasEquipList[1][3].effect_name, effect_value: GameData.userData.hasEquipList[1][3].effect_value, equip_quality: GameData.userData.hasEquipList[1][3].equip_quality, equip_lv: GameData.userData.hasEquipList[1][3].equip_lv },

                    { equip_id: GameData.userData.hasEquipList[2][0].equip_id, effect_name: GameData.userData.hasEquipList[2][0].effect_name, effect_value: GameData.userData.hasEquipList[2][0].effect_value, equip_quality: GameData.userData.hasEquipList[2][0].equip_quality, equip_lv: GameData.userData.hasEquipList[2][0].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[2][1].equip_id, effect_name: GameData.userData.hasEquipList[2][1].effect_name, effect_value: GameData.userData.hasEquipList[2][1].effect_value, equip_quality: GameData.userData.hasEquipList[2][1].equip_quality, equip_lv: GameData.userData.hasEquipList[2][1].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[2][2].equip_id, effect_name: GameData.userData.hasEquipList[2][2].effect_name, effect_value: GameData.userData.hasEquipList[2][2].effect_value, equip_quality: GameData.userData.hasEquipList[2][2].equip_quality, equip_lv: GameData.userData.hasEquipList[2][2].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[2][3].equip_id, effect_name: GameData.userData.hasEquipList[2][3].effect_name, effect_value: GameData.userData.hasEquipList[2][3].effect_value, equip_quality: GameData.userData.hasEquipList[2][3].equip_quality, equip_lv: GameData.userData.hasEquipList[2][3].equip_lv },

                    { equip_id: GameData.userData.hasEquipList[3][0].equip_id, effect_name: GameData.userData.hasEquipList[3][0].effect_name, effect_value: GameData.userData.hasEquipList[3][0].effect_value, equip_quality: GameData.userData.hasEquipList[3][0].equip_quality, equip_lv: GameData.userData.hasEquipList[3][0].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[3][1].equip_id, effect_name: GameData.userData.hasEquipList[3][1].effect_name, effect_value: GameData.userData.hasEquipList[3][1].effect_value, equip_quality: GameData.userData.hasEquipList[3][1].equip_quality, equip_lv: GameData.userData.hasEquipList[3][1].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[3][2].equip_id, effect_name: GameData.userData.hasEquipList[3][2].effect_name, effect_value: GameData.userData.hasEquipList[3][2].effect_value, equip_quality: GameData.userData.hasEquipList[3][2].equip_quality, equip_lv: GameData.userData.hasEquipList[3][2].equip_lv },
                    { equip_id: GameData.userData.hasEquipList[3][3].equip_id, effect_name: GameData.userData.hasEquipList[3][3].effect_name, effect_value: GameData.userData.hasEquipList[3][3].effect_value, equip_quality: GameData.userData.hasEquipList[3][3].equip_quality, equip_lv: GameData.userData.hasEquipList[3][3].equip_lv },
                ],

                //临时装备数据
                data.user_data.temporaryEquipData_list = [
                    { equip_id: GameData.userData.temporaryEquipData.equip_id, effect_name: GameData.userData.temporaryEquipData.effect_name, effect_value: GameData.userData.temporaryEquipData.effect_value, equip_quality: GameData.userData.temporaryEquipData.equip_quality, equip_lv: GameData.userData.temporaryEquipData.equip_lv },
                ]
        ...
        console.log("进入主界面的数据GameData.userData.hasEquipList:", GameData.userData.hasEquipList);
        console.log("进入主界面的数据GameData.userData.hasGoodsList:", GameData.userData.hasGoodsList);
        console.log("进入主界面的数据GameData.userData.inviteTodayAdLastNum:", GameData.userData.inviteTodayAdLastNum);
    }
}
